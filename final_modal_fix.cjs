...
const cleanModal = `function ProjectTypesModal({ t, lang, dbProjectTypes, dbProjectPhases, onReload, reloadPhases, setModal, onClose }) {
...
if (startIndex !== -1) {
  content = content.substring(0, startIndex) + cleanModal;
